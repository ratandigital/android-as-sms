...
$statusValues = array(__("status_all") => "", __("pending") => "Pending", __("queued") => "Queued", __("sent") => "Sent", __("delivered") => "Delivered", __("failed") => "Failed", __("received") => "Received", __("scheduled") => "Scheduled");
                    ...
                    <form role="form" id="formMessages" autocomplete="off">
                        ...
                        <div class="box-footer">
                            <div class="col-xs-8">
                                ...
                                <button type="button" id="resend" style="margin-right: 4px" class="btn btn-warning"><i
                ...
                <div class="modal-content">
                    ...
                    <form id="reply-message">
                        <div class="modal-body">
                            <input type="hidden" name="mobileNumber" id="numberReplyInput" class="form-control"
                                   required="required">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="replyMessageButton" class="btn btn-warning"><i
