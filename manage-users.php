                ...
                <div class="box box-warning">
                    ...
                    <form role="form" id="create-user" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="confirmEmailInput"><?= __("confirm_email"); ?></label>
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-envelope"></i>
                                    </div>
                                    <input type="email" name="confirmEmail" class="form-control" id="confirmEmailInput"
                                           placeholder="<?= __("confirm_email"); ?>" required="required">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <button type="submit" id="createUserButton" name="createUser" class="btn btn-warning"><i
                ...
                <div class="modal-content">
                    ...
                    <form id="edit-user">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="editUserButton" class="btn btn-warning"><i class="fa fa-save"></i>&nbsp;<?= __("save_changes") ?>
                            </button>
                        </div>
                    </form>
                </div>
