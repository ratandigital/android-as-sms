            ...
            <div class="col-md-12">
                ...
                <div class="box box-warning">
                    ...
                    <form role="form" id="settings" method="post">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="receivedSmsEmailInput">
                                            <input type="checkbox" name="smsToEmail" value="1" id="toggleReceivedSmsEmailInput"
                        ...
                        <div class="box-footer">
                            <button type="submit" id="saveSettingsButton" name="saveSettings" class="btn btn-warning"><i
