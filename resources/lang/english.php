...
$lang = [
    ...
    'pending_ussd_requests' => 'Pending USSD Requests',
    'sent_ussd_requests' => 'Sent USSD Requests',
    ...
    'new_user_limitations' => "New user limitations ( 0 → Unlimited )",
    ...
    'attachments_links' => 'Links to attachments (*.png, *.jpg, *.gif)',
    'attachments' => 'Attachments (*.png, *.jpg, *.gif)',
    'type' => 'Type',
    ...
    'excel_message_placeholder' => 'You can use a placeholder as shown in the following message and it will replace it automatically with an appropriate value.
&quot;Hi %name%, How are you?&quot;
In the above example, the system will replace %name% with data from the Name column. You must have Name column in your Excel file for it to work.',
    ...
    'debug' => 'Debug',
    'username' => 'Username',
    'application_copyright' => '<strong>Copyright &copy; 2018-%present% <a href="%url%" id="company_url">%name%</a></strong>. All rights
    reserved.',
    ...
    'contacts_message_placeholder' => 'You can use a placeholder as shown in the following message and it will replace it automatically with an appropriate value.
&quot;Hi %name%, How are you?&quot;',
