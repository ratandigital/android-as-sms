...
$lang = [
    ...
    'pending_ussd_requests' => 'Ausstehende USSD-Anfragen',
    'sent_ussd_requests' => 'Gesendete USSD-Anfragen',
    ...
    'new_user_limitations' => "Neue Benutzerbeschränkungen ( 0 → Unbegrenzt )",
    ...
    'attachments_links' => 'Links zu Anhängen (* .png, * .jpg, * .gif)',
    'attachments' => 'Anhänge (* .png, * .jpg, * .gif)',
    'type' => 'Art',
    ...
    'excel_message_placeholder' => 'Sie können einen Platzhalter wie in der folgenden Meldung gezeigt verwenden, der automatisch durch einen geeigneten Wert ersetzt wird.
...
Im obigen Beispiel ersetzt das System %name% durch Daten aus der Spalte Name. Sie müssen die Spalte Name in Ihrer Excel-Datei haben, damit dies funktioniert.',
    ...
    'contacts_message_placeholder' => 'Sie können einen Platzhalter wie in der folgenden Nachricht gezeigt verwenden, der ihn automatisch durch den entsprechenden Wert ersetzt.,
