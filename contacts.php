                ...
                <div class="box box-warning">
                    ...
                    <form role="form" id="create-list" method="post">
                        ...
                        <div class="box-footer">
                            <button type="submit" id="createListButton" name="createList" class="btn btn-warning"><i
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            ...
                            <div class="pull-right">
                                <button type="button" id="edit-list" style="margin-right: 4px" class="btn btn-warning">
                                    <i class="fa fa-edit"></i><span
                                            class="hidden-xs hidden-sm">&nbsp;<?= __("edit_list"); ?></span>
                                </button>
                                <button type="button" id="refresh-list" style="margin-right: 4px" class="btn btn-warning">
                        ...
                        <div class="box-footer">
                            <div>
                                ...
                                <button type="button" style="margin-right: 4px" class="btn btn-warning" id="move-selected"
                                ...
                                <button type="button" style="margin-right: 4px" class="btn btn-warning"
                    ...
                    <div class="modal-content">
                        ...
                        <form id="add-contact">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="addContactButton" class="btn btn-warning"><i
                                            class="fa fa-save"></i>&nbsp;<?= __("create") ?>
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="edit-contacts-list">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="editContactsListButton" class="btn btn-warning"><i
                    ...
                    <div class="modal-content">
                        ...
                        <form id="move-contacts">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="moveContactsButton" class="btn btn-warning"><i
                                            class="fa fa-save"></i>&nbsp;<?= __("save") ?>
                                </button>
                            </div>
                        </form>
