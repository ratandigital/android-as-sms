                ...
                <div class="box box-warning">
                    ...
                    <form role="form" id="addResponse" method="post">
                        ...
                        <div class="box-footer">
                            <button type="submit" id="addResponseButton" class="btn btn-warning"><i
                ...
                <div class="modal-content">
                    ...
                    <form id="editResponseForm">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="editResponseButton" class="btn btn-warning"><i
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function initComplete() {
            $("#responses").off().on("click", ".edit-response", function (event) {
