                ...
                <div class="box box-warning">
                    <div class="box-header with-border">
                        ...
                        <?php if ($_SESSION["isAdmin"]) { ?>
                            <button type="button" id="button-create-subscription" class="btn btn-warning pull-right"
                    ...
                    <div class="modal-content">
                        ...
                        <form id="createSubscriptionForm">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="createSubscriptionButton" class="btn btn-warning"><i
...
<script type="text/javascript">
    $(function () {
        ...
        function initSubscriptions() {
            $("#subscriptions").off().on("click", ".cancel-subscription", function (event) {
        ...
        function initPayments() {
            $("#payments").off().on("click", ".refund-payment", function (event) {
                event.preventDefault();
