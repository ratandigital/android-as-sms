                ...
                <div class="box box-warning">
                    ...
                    <form role="form" id="createPlanForm" method="post">
                        ...
                        <div class="box-footer">
                            <button type="submit" id="createPlanButton" name="createPlan" class="btn btn-warning"><i
                ...
                <div class="modal-content">
                    ...
                    <form id="editPlanForm">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="editPlanButton" class="btn btn-warning"><i class="fa fa-save"></i>&nbsp;<?= __("save_changes") ?>
                            </button>
                        </div>
                    </form>
                </div>
