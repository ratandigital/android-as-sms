                ...
                <div class="modal-content">
                    ...
                    <form id="edit-device">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="editDeviceButton" class="btn btn-warning"><i class="fa fa-save"></i>&nbsp;<?= __("save_changes") ?>
                            </button>
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="share-device">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="shareDeviceButton" class="btn btn-warning"><i class="fa fa-save"></i>&nbsp;<?= __("save_changes") ?>
                            </button>
                        </div>
                    </form>
                </div>
