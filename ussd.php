                    ...
                    <form role="form" id="form-send-ussd" method="post">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="requestInput"><?= __("ussd_request"); ?></label>
                        ...
                        <div class="box-footer">
                            <button type="submit" id="btn-send-ussd" class="btn btn-warning"><i
                ...
                <div class="box box-warning">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right">
                            <button type="button" id="resend-selected" class="btn btn-warning" disabled><i
