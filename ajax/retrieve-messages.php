...
try {
    ...
    if (isset($_POST["startDate"]) && isset($_POST["endDate"])) {
        ...
        foreach ($messages as $message) {
            ...
            if (in_array($message->getStatus(), ["Received", "Sent", "Delivered"]) && $_SESSION["userID"] == $message->getUserID() && $message->getDeviceID() != null && isValidMobileNumber($message->getNumber())) {
                $replyText = __("reply");
