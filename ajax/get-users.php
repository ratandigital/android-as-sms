...
try {
    ...
    if ($_SESSION["isAdmin"]) {
        ...
        foreach ($users as $user) {
            ...
            $row[] = $user["UserLastLogin"] == null ? "Never" : getDisplayTime($user["UserLastLogin"])->format("Y-m-d H:i:s");
            $data[] = $row;
        }
